...
![](https://mmbiz.qpic.cn/mmbiz_png/NMByQQfVwfdHrXxA0hztdo8RolLSR1EsRM2KRESHz8C8Ct4q2JWUKB4HP7icIcj11icANvDI8W9V4OyLPmR7KO3IfgNuQqecPND5L4tAUQH3g/640?wx_fmt=png&from=appmsg)

![](https://mmbiz.qpic.cn/mmbiz_png/NMByQQfVwfd8dN9AOrDRJGt2ZD6n224UYuJFQmEg7AeEN14Cy45zkRtRhZHXO6daWy4q0I82iav2NibIfYY4iajuFZp5NLu93YxzHoONgk2x5o/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/NMByQQfVwffxmubx0MBMKyU8Nbz1P9m6vdrE82kt3T8yRLxnaTDL7I2rPFGib84JH6ezuQLWs945cYico7QSoRjORNd5KWMqsN9QXuWnvpAA0/640?wx_fmt=png&from=appmsg)
...
@@IMG:|https://mmbiz.qpic.cn/sz_mmbiz_png/NMByQQfVwfeKSYGUjJd9ndH33M7jBIR3a9xa6xUYJ46XOJndfs1EaMAKewxicOC6607toz0mxmqb7b9iaO37u007zMsR8s5CpQF6yRs25zicW4/640?wx_fmt=png&from=appmsg@@

之前我们是直接拼接字符串，而现在用 Prompt Template 的 api 来管理。

![](https://mmbiz.qpic.cn/mmbiz_png/NMByQQfVwfezrW5rnWNhG2r534vw0O3O08iaz0s5ReINz6W4xryqib80QHDLiccj9Ls1H5A03qfQvkRMfibQGAvV7Er7jFSH4wuicxNWtCddFWYg/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/NMByQQfVwfeTMia4dib9ofp6n8LgtWCa7DSjpfbdicCgy76YKaVZcjmwaVGs0ELccqicOUoPb50JVTst4uw4g6jD9dXKurlGgYJgS8u8gEzFxz8/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/NMByQQfVwffFkkLYmzdBb4vhaVhcOLYk1pZCsDiadHbzDsSQ1p2IoaMsiaEhkxKHibOajnggWnZeUUruy5AfBZoeibiaj3BJa2C4BVSiapPPicTUls/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/NMByQQfVwffFmAsVIb1mMdgJuymnXM2jDl7GbUFOl6eL2HVDPUEnYIoJsCWtQ9taDZP6oOBFQROricBR78kkMz1ey8mYkxgy5alJd4w4IX5o/640?wx_fmt=png&from=appmsg)

PromptTemplate 产出的就是一个字符串，实际上我们更多是用 SystemMesage、HumanMessage、AIMessage、ToolMessage 的 messages 数组来调大模型：

![](https://mmbiz.qpic.cn/mmbiz_png/NMByQQfVwfedkmty1tjV1T8z8V7ozjRPRFPeO8iaVOkoY3E9e4ao1tODicPaKNZ19eEElLXvIdnvz0iagw47RMicgd6IUnQ6WBuZseMJnNUWJSA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/NMByQQfVwfenr2icGZgJAAVjekekFrjS0ZSWh2oZRM9Tg9icOhZnHrs4NP7iaxX7rtX59jB4jRsoh13a3b79BMHnWOAhEMibU3nCzSUjs7LqFzQ/640?wx_fmt=png&from=appmsg)

实际上还是 ChatPromptTemplate 用的多，也就是 messages 数组的方式管理 prompt

那之前的 PipelinePromptTemplate 一般就是这样用：
...
这里我们复用了之前的两个 PromptTemplate，然后创建了两个新的 PromptTemplate
...
![](https://mmbiz.qpic.cn/mmbiz_png/NMByQQfVwfdW9vMv7zd7NNFnWCN5NTWyywtxiaJorhzPttErXQgribyKqL1PyrCSYLPmaqrAcGHOzB1GWK0Y2OWBVk6G3DbJ4RYa92EXyfn7w/640?wx_fmt=png&from=appmsg)
 ...
 * 创建或获取集合
 */
asyncfunction ensureCollection() {
try {
    // 检查集合是否存在
...
![](https://mmbiz.qpic.cn/mmbiz_png/NMByQQfVwfcWEU43x52KXudoCtcswhS9GZlqibJIECABVkR599fVvL5Jt8RxejeQ7C0mibyEzKBpuJ69ict6qgmwrcS3I5xYZIUpxgKiaa9YEic4/640?wx_fmt=png&from=appmsg)
