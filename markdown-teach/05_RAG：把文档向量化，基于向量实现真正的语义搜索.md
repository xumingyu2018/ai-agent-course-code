...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUdxDmoQQP5SID9L1bPxicBR9p21E3GvSalicX3wib5BPFRGttYAiaus22153lDsnQd4aYk4vsemhfZfQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUdxDmoQQP5SID9L1bPxicBRFO0cVf7cb4vkHP3helaYf5ViaQIBaENn9OuSa3NiafTZCT5B3HfyqddQ/640?wx_fmt=png&from=appmsg)

明显可以看出来，苹果、水果、香蕉，这三个概念相关性很大，而水果和石头相关性就不大。

计算的话，可以通过夹角判断相似度，夹角越小相似度越高：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUdxDmoQQP5SID9L1bPxicBRLZ5ibdB1iaTWDCVjic5CMIOCqqJHkUtkp7vysxr4Cicib7a1UhuMApEJQMQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUdxDmoQQP5SID9L1bPxicBRhCfZdegEMhHqU3QChnCoPPe5bdXbvI2EYicbJs6HYVlHYRQnM2DmhOg/640?wx_fmt=png&from=appmsg)

我们写代码会用专门的嵌入模型，收费比大模型便宜很多很多。

那加上向量化之后的 RAG 流程是什么样的呢？

![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUdxDmoQQP5SID9L1bPxicBRLx5xfb6PIqpzP5g8jmwjTiaMHViaLvLsBs4vsPnNgF6LXdB2ctkEJicXQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUdxDmoQQP5SID9L1bPxicBRd2FLk3h0TYnficHOAXK7kYOu8vDAHFr0NUkukcsaCOgHOCR9Yqzs36g/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUdxDmoQQP5SID9L1bPxicBRcjWJKiaQftCCVuvpt1vOg1158wiaKh8vcDNUrqZRk9RYicL7ibVW1zicDKg/640?wx_fmt=png&from=appmsg)

具体的 model name 在 .env 里配置下：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUdxDmoQQP5SID9L1bPxicBRx2kEQry6eJkjGyrSXZCicNZ5RgickNicE8AvYp3deNsmqXQXLQtnWKa7g/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUdxDmoQQP5SID9L1bPxicBRcM0ETLjAvPj7XlSI600AYber3beZKJnYIOXfAOWhluLAdNuhTS1N1A/640?wx_fmt=png&from=appmsg)

知识库里存的就是这些文档，可以加一些元数据。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUdxDmoQQP5SID9L1bPxicBRnZJydpavAK4CMVYIEdjKcibe8SJYKSn8kYJfTa1zM6euYPTWKzWltHA/640?wx_fmt=png&from=appmsg)

用嵌入模型把这些文档向量化之后存入向量数据库。

并且返回一个 retriever，k 是 3 就是返回余弦相似度最大的 3 个 Document。

![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUdxDmoQQP5SID9L1bPxicBRVobAiaUmjuxEx4icicbxia2SumJvsVOn4ibwMwcjhicHEv8QibhKMucH66V7w/640?wx_fmt=png&from=appmsg)

用 retriever 把 query 传入，通过向量的余弦相似度，找到语义最相关的 3 个文档片段，传入 prompt：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jUdxDmoQQP5SID9L1bPxicBRymB5GQFpbL4y5FeID4oQty8MaSy8jH41uU06hzqVGl3fYXYgkyRdsQ/640?wx_fmt=png&from=appmsg)

这就是增强后的 Prompt 了，之后问大模型问题的时候，它就有背景知识了。

跑一下：

**🎬 [视频 1](http://mpvideo.qpic.cn/0bc3uyalaaaazuabea2s5nuvbjwdwctabmaa.f10002.mp4?dis_k=97cb1da72db5f2dc8fe31f9656399fee&dis_t=1781680176&play_scene=10110&auth_info=V5em9u1UZabwiMsHZuXHoogNG0NAHWsJLDozSB8yeBhqNn1NamJbYk1KSkwRTEl+ImEWY1QX&auth_key=3b412906b51eaf1120aef7957acba8f9)**

![视频1](assets/05_video_1.gif)
